...
data StartRails = MkStartRails String String String deriving (Eq, Show,Ord)

data CurrentRailMovementDirection = MkCurrentRailMovementDirection Int Int deriving (Eq,Show,Ord)
