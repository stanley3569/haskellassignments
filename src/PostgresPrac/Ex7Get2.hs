...
instance ToJSON User where
    toJSON (User userid username userValid )=
        object ["userid" .= show userid, "userid" .= show username, "userValid" .= show userValid]
            ...
            (do head_
                ...
                body_
                    (do div_ [id_ "header",style_ "color:white"] "Table Customer"
                        form_ [id_ "customerForm", method_ "get"]
                            (do label_ "userid"
